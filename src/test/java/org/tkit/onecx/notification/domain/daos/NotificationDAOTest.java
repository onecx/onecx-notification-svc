...
class NotificationDAOTest {
    ...
    void methodExceptionTests() {
        methodExceptionTests(() -> dao.findAllNotDelivered(),
                NotificationDAO.ErrorKeys.ERROR_FIND_ALL_NOT_DELIVERED);
        methodExceptionTests(() -> dao.markAsDelivered(null),
                NotificationDAO.ErrorKeys.ERROR_MARK_AS_DELIVERED);
    }
